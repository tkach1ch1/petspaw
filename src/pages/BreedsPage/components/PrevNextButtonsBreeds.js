...
import { increaseBreedsPage, decreaseBreedsPage } from '../../../redux/breedsPageReducer'
import { StyledTypography } from '../../../components/style/style'
import { DisabledButton } from '../style/style'

export const PrevNextButtonsBreeds = (props) => {
    // Buttons hover
    ...
    const onHandleNextClick = () => {
        if (limitedBreeds.length === Number(props.limit)) dispatch(increaseBreedsPage())
    }
